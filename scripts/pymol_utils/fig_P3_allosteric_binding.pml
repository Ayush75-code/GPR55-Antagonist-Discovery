# ============================================================
# Figure: AM251 Control at P3 Allosteric Site (-7.702 kcal/mol)
# Run in PyMOL: File > Run Script
# ============================================================

# Load structures
load D:/Antigravity AI/Major Project/Phase 1 calidation (Control)/GPR55_receptor.pdbqt
load D:/Antigravity AI/Major Project/Phase 1 calidation (Control)/result/raw_outputs/AM251_control_P3_Allosteric_PPI/run_3.pdbqt
...
zoom (pocket or lig)
ray 1600, 1200
png D:/Antigravity AI/Major Project/Figures/PyMOL_Renders/AM251_Control_P3_Allosteric.png, dpi=600
